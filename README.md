...
## v0.3.2 — China & Global Work Expansion
...
## v0.3.2 — Four-layer Vocabulary Lab

Vocabulary Lab agora possui quatro camadas: Active Vocabulary (366), Thinking Toolkit (108), Idea Frameworks (40) e Business Roles Glossary (24 papéis, 192 termos semânticos e 144 collocations). Todos os novos conteúdos usam o mesmo controle persistente de velocidade de áudio.


## v0.3.2 — Bilingual Taxonomy
- Idea Frameworks agora exibem tradução PT de propósito, conectores, exemplos e prompts.
- Business Roles agora exibem tradução PT de papel, definição, termos semânticos e collocations.
- Semantic Fields foram organizados em grupos semânticos como ciclo/status, valor/prioridade, geografia/escopo, autoridade/senioridade, modelo de relação, função/especialidade e desempenho/risco.
